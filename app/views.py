...
def insert_bank(self):
    with open('C:\\Users\\swaga\\OneDrive\\Desktop\\DJANGO\\swagatika\\Scripts\\csv_files\\app\\bank.csv','r')as FO:
        IOD=csv.reader(FO)
        for i in IOD:
            bn=i[0].strip()
...
def insert_branch(self):
    with open('C:\\Users\\swaga\\OneDrive\\Desktop\\DJANGO\\swagatika\\Scripts\\csv_files\\app\\branch1.csv','r')as FO:
        IOD=csv.reader(FO)
        next(IOD)
        for i in IOD:
            bn=i[0]
